    ...
    <div className="flex h-dvh flex-col overflow-hidden pt-[var(--pw-nav-offset)]">
      ...
      <div className="flex min-h-0 flex-1 flex-col lg:flex-row">
        <section className="relative min-h-[52vh] flex-1">
          <div className="pointer-events-none absolute left-0 right-0 top-0 z-10 flex items-start justify-between gap-4 px-5 pb-5 pt-4">
        ...
        <aside className="relative z-0 flex w-full shrink-0 flex-col border-t border-border bg-surface lg:h-auto lg:w-[400px] lg:border-l lg:border-t-0">
